...
class declarationFormGenerator {
    ...
    public function getDeclarationButtonsChoice() { 
        $form = null;
        $this->current_showing_items_num = 0;
        if ( !isset( $_POST[ 'CN22_button' ] ) && !isset( $_POST[ 'CN23_button' ] ) ) {
            $form .= '<div class="declaration_buttons_choice_wrapper">';
            $form .= '<form method="post">';
            $form .= '<button type="submit" name="CN22_button" class="CN22_button_class">Generator deklaracji CN22</button>';
            $form .= '</form>';
            $form .= '<form method="post">';
            $form .= '<button type="submit" name="CN23_button" class="CN23_button">Generator deklaracji CN23</button>';
            $form .= '</form>';
            $form .= '</div>';
        }
        
        if ( isset( $_POST[ 'CN22_button' ] ) ) {
            $this->maximum_items_in_declaration = $this->general_settings->numbers_of_max_items_cn22;
            $form .= '<div class="CN22wrapper">';
            $form .= '<form id="full_form" action="/wp-content/plugins/sema_generate_declaration_plugin/sema_pdf_generator.php" method="post" target="_blank">';
        ...
        } else if ( isset( $_POST ['CN23_button'] ) ) {
