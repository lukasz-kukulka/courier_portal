...
return [
    ...
    */
    ...
    "name_message_regex" => "Dopuszczalna ilość znaków 25. Nie może zaczynać się od spacji ani znaku specjalnego.",
    "surname_message_regex" => "Dopuszczalna ilość znaków 49. Nie może zaczynać się od spacji ani znaku specjalnego.",
    "email_message_regex" => "Podaj poprawny adres e-mail. Adres powinien zawierać znaki alfanumeryczne oraz jeden znak '@'.",
    "phone_message_regex" => "Numer telefonu musi być w formacie międzynarodowym i składać się z co najmniej 8 cyfr.",
    "phone_number_message_regex" => "Numer telefonu musi być w formacie międzynarodowym i składać się z co najmniej 8 cyfr.",
    "address_message_regex" => "Adres musi być w poprawnym formacie, zawierającym ulicę, numer domu i kod pocztowy.",
    "company_name_message_regex" => "Nazwa firmy musi zawierać od 2 do 100 znaków, w tym litery, cyfry i znaki specjalne.",
    "company_address_message_regex" => "Adres firmy musi być w poprawnym formacie, zawierającym ulicę, numer domu i kod pocztowy.",
    "company_phone_number_message_regex" => "Numer telefonu firmy musi być w formacie międzynarodowym i składać się z co najmniej 8 cyfr.",
    "company_post_code" => "Kod pocztowy firmy musi być w poprawnym formacie.",
    "company_city_message_regex" => "Miasto musi zawierać od 2 do 100 znaków i nie może zawierać cyfr ani znaków specjalnych.",
    "company_country_message_regex" => "Kraj musi zawierać od 2 do 60 znaków i nie może zawierać cyfr ani znaków specjalnych.",
    "quantity_input_message_regex" => "Ilość musi być liczbą całkowitą od 1 do 10.",
    "weight_input_message_regex" => "Waga musi być liczbą, a jednostka powinna być w formacie kg",
    "value_input_message_regex" => "Wartość paczki musi być liczbą z maksymalnie dwoma miejscami po przecinku podaną w £.",
    "description_message_regex" => "Opis przedmiotu musi mieć od 1 do 500 znaków.",
    "name_surname_message_regex" => "Dopuszczalna ilość znaków 75. Nie może zaczynać się od spacji ani znaku specjalnego.",
    "business_name_message_regex" => "Dopuszczalna ilość znaków 100, w tym litery, cyfry i znaki specjalne.",
    "street_message_regex" => "Ulica musi być w poprawnym formacie, zawierającym nazwę ulicy i numer domu.",
    "city_message_regex" => "Miasto musi zawierać od 2 do 100 znaków i nie może zawierać cyfr ani znaków specjalnych.",
    "country_message_regex" => "Dopuszczalna ilość znaków 60 i nie może zawierać cyfr ani znaków specjalnych.",
