...
return [
    ...
    */
    ...
    "default_date_direction_option" => "Wybierz kierunek",
    "courier_announcement_date_id" => "Nr.",
    "courier_announcement_date_direction_name_from" => "Kierunek z",
    "courier_announcement_date_direction_name_to" => "Kierunek do",
    ...
    "direction_print_full_name_test" => "TEST KIERUNKI",
