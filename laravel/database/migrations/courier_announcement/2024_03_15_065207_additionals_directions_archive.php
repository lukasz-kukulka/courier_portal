...
return new class extends Migration
{
    public function up(): void {
        Schema::create('courier_announcement_additional_directions_archive', function (Blueprint $table) {
    ...
    public function down(): void {
        Schema::dropIfExists('courier_announcement_additional_directions_archive');
    }
};