function addNewCargoTypeButton() {
    ...
    button.addEventListener("click", function (event) {
        ...
        if (cargo.currentCargoIndex < cargo.maxCargoIndex) {
            ...
            let cargoComponent = document.querySelector(
                ".cargo_component_" + cargo.currentCargoIndex
            );
            cargoComponent.style.display = "table-row";
        }
        if (cargo.currentCargoIndex >= cargo.maxCargoIndex) {
            const addCargoButton = document.querySelector(
                ".add_new_cargo_type_button"
            );
        ...
        button.addEventListener("click", function (event) {
            ...
            if (cargo.maxCargoIndex > parseInt(match[1])) {
                for (
                    ...
                    i <= cargo.currentCargoIndex;
                    i++
                ) {
                    var cargoCurrentNameInput = document.querySelector(
                        "#cargo_name_" + (i + 1).toString()
                    ).value;
                    var cargoCurrentDescriptionInput = document.querySelector(
                        "#cargo_description_" + (i + 1).toString()
                    ).value;
                    var cargoCurrentPriceInput = document.querySelector(
                        "#cargo_price_" + (i + 1).toString()
                    ).value;
                    var cargoCurrentCurrencyInput = document.querySelector(
                        "#select_currency_" + (i + 1).toString()
                    ).value;
                    document.querySelector(
                        "#cargo_name_" + i.toString()
                    ).value = cargoCurrentNameInput;
                    document.querySelector(
                        "#cargo_description_" + i.toString()
                    ).value = cargoCurrentDescriptionInput;
                    document.querySelector(
                        "#cargo_price_" + i.toString()
                    ).value = cargoCurrentPriceInput;
                    document.querySelector(
                        "#select_currency_" + i.toString()
                    ).value = cargoCurrentCurrencyInput;
                }
            }
            const cargoComponent = document.querySelector(
                ".cargo_component_" + cargo.currentCargoIndex
            );
...
function accessForAddNextElementToCArgoType() {
    for (let index = 1; index <= cargo.maxCargoIndex; index++) {
        const inputName = document.querySelector(
            "#cargo_name_" + index.toString()
        );
        const inputPrice = document.querySelector(
            "#cargo_price_" + index.toString()
        );
        const inputCurrency = document.querySelector(
            "#select_currency_" + index.toString()
        );
        const inputNameInfo = document.querySelector(
            "#cargo_name_info_" + index.toString()
        );
        ...
        inputName.addEventListener("input", function () {
            if (this.value.length >= 3) {
                ...
                for (
                    let visible_item_index = cargo.currentCargoIndex - 1;
                    visible_item_index >= 1;
                    visible_item_index--
                ) {
                    const inputNameTemp = document.querySelector(
                        "#cargo_name_" + visible_item_index.toString()
                    );
            ...
            setAddNewCargoTypeButtonVisible(
                cargo.nameInfoIsVisible,
                cargo.priceInfoIsVisible,
                cargo.currencyInfoIsVisible
            );
        });
        ...
        inputPrice.addEventListener("input", function () {
            if (parseFloat(this.value) > 0) {
                ...
                for (
                    ...
                    const inputPriceTemp = document.querySelector(
                        "#cargo_price_" + visible_item_index.toString()
                    );
            ...
            setCurrencyAndPriceInfoVisible(
                cargo.priceInfoIsVisible,
                cargo.currencyInfoIsVisible
            );
        });
        ...
        inputCurrency.addEventListener("change", function () {
            if (this.value !== "option_default") {
                ...
                for (
                    ...
                    const inputCurrencyTemp = document.querySelector(
                        "#select_currency_" + visible_item_index.toString()
                    );
...
function setCurrencyAndPriceInfoVisible(
    priceValue,
    currencyValue,
    currentIndex = 0
) {
    let index = currentIndex != 0 ? currentIndex : cargo.currentCargoIndex;
    const inputPriceAndCurrencyInfo = document.querySelector(
        "#cargo_price_info_" + index.toString()
    );
...
function checkLastCargoItem() {
    const inputName = document.querySelector(
        "#cargo_name_" + cargo.currentCargoIndex.toString()
    );
    const inputPrice = document.querySelector(
        "#cargo_price_" + cargo.currentCargoIndex.toString()
    );
    const inputCurrency = document.querySelector(
        "#select_currency_" + cargo.currentCargoIndex.toString()
    );
...
function setDeleteActionOnFirstElementOnCargo() {
    var deleteButton = document.querySelector(
        ".action_cargo_container_button_1"
    );
    var cargoActionInfo = document.querySelector(
        ".action_cargo_container_info"
    );
